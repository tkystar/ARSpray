...
#pragma warning restore 618
    public class NetworkManagerUIController : MonoBehaviour
    {
        ...
        public NewClientBtn NewClientBtn;

        /// <summary>
        /// The Panel containing the list of available rooms to join.
        /// </summary>
        public GameObject RoomListPanel;
        public GameObject beforedrawing;
        /// <summary>
...
#pragma warning restore 618
        ...
        /// </summary>
        public void OnReturnToLobbyClick()   //ロビーに戻る
        {
        ...
        public void OnAnchorHosted(bool success, string response)
        {
            if (success)
            {
                beforedrawing.SetActive(true);
                SnackbarText.text = "とうめいなめんをタップして絵をかこう.";　//タップして面ハルところよaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
            ...
            {
                SnackbarText.text = "アンカーがホストできていません. " + response;
            }
        }
        ...
        public void OnAnchorResolved(bool success, string response)
        {
            if (success)
            {
                SnackbarText.text = "じゅんびかんりょう！絵をかいてみよう！";
                SprayCan.SetActive(true);
                ColorSelector.SetActive(true);
                beforedrawing.SetActive(true);
            }
            ...
            {
                SnackbarText.text =
                    "じゅんびはまだかんりょうしていません。つづけてトライしてみよう. " + response;
            }
        }
...
#pragma warning restore 618
                {
                    ...
                    var text = "部屋 " + _GetRoomNumberFromNetworkId(match.networkId);                  //ルームナンバー
...
#pragma warning restore 618
        {
            if (!success)
            {
                SnackbarText.text = "マッチを作れません: " + extendedInfo;
                return;
            }
            ...
            SnackbarText.text = "サーバーにせつぞくしています...";
            _ChangeLobbyUIVisibility(false);
            CurrentRoomLabel.GetComponentInChildren<Text>().text =m_CurrentRoomNumber;/////////////
        }
...
#pragma warning restore 618
        {
            if (!success)
            {
                SnackbarText.text = "マッチに入れませんでした: " + extendedInfo;
                return;
            }

            m_Manager.OnMatchJoined(success, extendedInfo, matchInfo);
            m_CurrentRoomNumber = _GetRoomNumberFromNetworkId(matchInfo.networkId);
            SnackbarText.text = "サーバーにせつぞく中...";
            _ChangeLobbyUIVisibility(false);
            CurrentRoomLabel.GetComponentInChildren<Text>().text = "" + m_CurrentRoomNumber;       /////////////////////////////////////////////////////////////////
        }
