...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class CloudAnchorsExampleController : MonoBehaviour
    {
        ...
        public GameObject SprayController;
...
#pragma warning restore 618
            ...
            SprayScreen.SetActive(false);
            SprayController.SetActive(false);
            _ResetStatus();

            CompletedPlace = false;
        }
        ...
        public void Update()
        {
            ...
            if (Application.platform != RuntimePlatform.IPhonePlayer)
            {
                ...
                {
                    m_LastHitPose = arcoreHitResult.Pose;    ///hitしたら
                }
            }
            else
            {
            ...
            if (m_LastHitPose != null)
            {
                ...
                if (_CanPlaceStars()&&!CompletedPlace)
                {
                    _InstantiateStar();    //コメントアウト中
                    //CubeGene();
                    //_InstantiateCube();
                }
        ...
        {
            _ReturnToLobbyWithReason("せつぞくできませんでした " +
                "別の部屋でやり直してください.");
        }
        ...
        private void _InstantiateStar()//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            GameObject.Find("LocalPlayer").GetComponent<LocalPlayerController>().CmdSpawnStar(Vector3.zero, Quaternion.identity);
            ...
            //GameObject.Find("LocalPlayer").GetComponent<LocalPlayerController>().CmdSpawnnew(m_LastHitPose.Value.position, m_LastHitPose.Value.rotation);
        ...
        private void _SetPlatformActive()
        {
            if (Application.platform != RuntimePlatform.IPhonePlayer)
            {
                ...
                ARKitRoot.SetActive(false);
                //SprayScreen.SetActive(true);
                SprayController.SetActive(true);
            }
            else
            {
                ARCoreRoot.SetActive(false);
        ...
        public void _SwitchActiveScreen(ActiveScreen activeScreen)
        {
            ...
            SprayScreen.SetActive(activeScreen == ActiveScreen.SprayScreen);
